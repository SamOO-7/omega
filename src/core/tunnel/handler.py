...
class _CustomHTTPConnection(http.client.HTTPConnection):
    ...
    def send(self, data):
        ...
        # fixes: https://github.com/entynetproject/omega/issues/65
...
class Request:
    ...
    # the parser format string, used to parse/unparse omega data
    parser = '<%SEP%>%s</%SEP%>'
    ...
    def __init__(self):
        ...
        # the parser/unparser are used to truncate omega
