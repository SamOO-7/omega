...
"""
This setting allows overriding default payload template.
It is used to generate the payload to be injected in TARGET url.
...
Indeed, PAYLOAD must evaluate the content of 'HTTP_%%PASSKEY%%'
header to work properly.

NOTE: %%PASSKEY%% is a magic string that is replaced by PASSKEY
      value at runtime.

* Only edit PAYLOAD if you really understand what you're doing
"""
import linebuf
import datatypes
