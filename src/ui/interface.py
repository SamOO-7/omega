...
class Shell(shnake.Shell):
    ...
    def do_corectl(self, argv):
        ...
        reload-plugins
            Reload all omega plugins.

            By default, the list of omega plugins is loaded
        ...
        python-console
            ...
            debugging, or to get help about a omega module, class,
        ...
        if argv[1] == "python-console":
            ...
            console.banner = "Omega corectl: python console interpreter"
            return console()
    ...
    def do_source(self, argv):
        ...
        DESCRIPTION:
            ...
            contained therein. As if each line was a omega
            command.
        ...
        EXAMPLES:
            > source /tmp/spl01t-script.omega
    ...
    def do_alias(self, argv):
        ...
        DESCRIPTION:
            Command aliases can be defined in order to ease omega
            shell experience.
